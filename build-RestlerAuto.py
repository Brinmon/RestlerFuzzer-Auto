...
if __name__ == '__main__':
    ...
    parser.add_argument('--repository_root_dir',
                        help='rest.fuzzing 仓库的根目录。'
                        '如果未指定，将从此脚本在该仓库中的位置推断根目录。',
